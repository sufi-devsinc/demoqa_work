exports.Widgets = class Widget {
    ...
    async Auto_Complete() {
        // Click li:has-text("Auto Complete")
        await page.locator('li:has-text("Auto Complete")').click();
        await expect(page).toHaveURL('https://demoqa.com/auto-complete');
        // Click .auto-complete__value-container >> nth=0
        await page.locator('.auto-complete__value-container').first().click();
        // Fill text=Type multiple color names 0 results available. Use Up and Down to choose options >> input[type="text"]
        ...
        // Fill text=Type multiple color names option Red, selected. 0 results available. Select is f >> input[type="text"]
        ...
        // Fill text=RedBlue >> input[type="text"]
        await page.locator('text=RedBlue >> input[type="text"]').fill('bla');
        // Fill text=RedBlack >> input[type="text"]
