exports.Widgets = class Widget {
    ...
    async Auto_Complete() {
        ...
        await this.page.locator('.auto-complete__value-container').first().click();
        await this.page.locator('text=Type multiple color names 0 esults available. Use Up and Down to choose options >> input[type="text"]').fill('red');
