...
exports.Widgets = class Widget {
    ...
    async Menu() {
        ...
        // Click #react-select-2-option-0-1
        await page.locator('#react-select-2-option-0-1').click();
        // Click #withOptGroup div:has-text("Group 1, option 2") >> nth=1
        await page.locator('#withOptGroup div:has-text("Group 1, option 2")').nth(1).click();
        // Click #react-select-2-option-1-1
