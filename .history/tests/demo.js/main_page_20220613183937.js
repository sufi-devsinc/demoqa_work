...
exports.main_pages = class main_page {
    ...
    async Login_credits() {
        await expect(this.page.locator('text=Welcome,')).toHaveText('Welcome,');
        await this.page.locator('text=New User').click();  
        await this.page.locator('[placeholder="First Name"]').fill('sufian');
        await this.page.locator('[placeholder="Last Name"]').fill('shafiqie');
        await this.page.locator('[placeholder="UserName"]').fill('sufian');
        await this.page.locator('[placeholder="Password"]').fill('Sufian@1');
