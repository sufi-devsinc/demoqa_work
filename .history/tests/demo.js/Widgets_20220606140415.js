exports.Widgets = class Widget {
    ...
    async initialize(){
        ...
        await thispage.locator('div:nth-child(4) > div > .card-up').click();
    }
    async Accordian() {
        await page.locator('li:has-text("Accordian")').click();
        // await expect(page).toHaveURL('https://demoqa.com/accordian'); await page.locator('text=Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem').click();
